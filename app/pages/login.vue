      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" @submit.prevent="onSubmit">
            <div>
              <form-input-label for="phone" label="Your phone" />
              <form-input-text id="phone" type="text" v-model="phone" :error="errors.phone"/>
              <form-input-error :message="errors.phone" />
            </div>
            <div>
              <form-input-label for="password" label="Your password" />
              <form-input-text id="password" type="password" v-model="password" :error="errors.password"/>
